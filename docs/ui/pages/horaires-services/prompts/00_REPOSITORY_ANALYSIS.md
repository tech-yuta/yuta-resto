...
Analyse the existing integrated route `/establishment/hours-services`.
...
- every document under `docs/ui/pages/horaires-services/`;
...
- current service-period, settings, and exception models;
