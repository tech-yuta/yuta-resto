...
An authorized restaurant manager configures the establishment's regular booking service periods, global booking rules, and booking exceptions.
...
- regular weekly service periods;
...
- service-period create and delete actions;
