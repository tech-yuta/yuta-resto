...
const tasksToday = [
  {
    title: 'Vérifier le stock des ingrédients clés',
    priority: 'Haute',
    time: '09:00',
    badge: 'destructive' as const,
  },
  {
    title: 'Passer commande fournisseurs',
    priority: 'Haute',
    time: '10:00',
    badge: 'destructive' as const,
  },
  {
    title: 'Entretien hebdomadaire (cuisine & salle)',
    priority: 'Moyenne',
    time: '11:30',
    badge: 'warning' as const,
  },
  {
    title: 'Nettoyage hotte aspirante',
    priority: 'Moyenne',
    time: '13:00',
    badge: 'warning' as const,
  },
  {
    title: 'Vérifier DLC produits frais',
    priority: 'Moyenne',
    time: '14:00',
    badge: 'warning' as const,
  },
  {
    title: 'Rapport de caisse du jour',
    priority: 'Basse',
    time: '22:30',
    badge: 'info' as const,
  },
  {
    title: 'Planifier le personnel demain',
    priority: 'Basse',
    time: '22:30',
    badge: 'info' as const,
  },
...
const reviewsToAnswer = [
  {
    ...
    name: 'Marie L.',
    stars: 5,
    text: 'Très bon accueil et plats délicieux !...',
    time: 'Il y a 2h',
  },
  {
    source: 'G',
    name: 'Thomas B.',
    stars: 4,
    text: 'Attente un peu longue mais cuisine...',
    time: 'Il y a 5h',
  },
  {
    source: 'f',
    name: 'Sophie D.',
    stars: 5,
    text: 'Meilleur restaurant vietnamien du...',
    time: 'Il y a 1j',
  },
  {
    source: 'T',
    name: 'Julien M.',
    stars: 4,
    text: 'Bon rapport qualité/prix, je...',
    time: 'Il y a 1j',
  },
  {
    source: 'G',
    name: 'Camille R.',
    stars: 2,
    text: 'Les plats sont bons mais le service...',
    time: 'Il y a 2j',
  },
];
...
const unreadEmails = [
  {
    sender: 'contact@fastviet.fr',
    subject: 'Demande de devis traiteur',
    time: '09:45',
  },
  {
    sender: 'reservation@futuroscope.com',
    subject: 'Groupe de 20 personnes — 28/06',
    time: '09:12',
  },
  {
    sender: 'partenariat@local-event.fr',
    subject: 'Proposition partenariat événement',
    time: 'Hier',
  },
];
...
const contentsToApprove = [
  ...
  {
    channel: 'Instagram',
    title: 'Atelier Petit Chef ✨',
    bg: 'bg-status-warning-soft',
    time: 'Hier',
  },
  {
    channel: 'Facebook',
    title: 'Bánh mì du jour',
  ...
  return (
    <div className="flex w-full flex-col gap-6">
          ...
          <div className="flex flex-1 flex-col divide-y divide-border-default">
            {reservationsToday.map((r) => (
              ...
              >
                ...
                <span className="w-14 shrink-0 text-sm text-primary/55">
                  {r.guests}
                </span>
          ...
          <div className="flex flex-1 flex-col divide-y divide-border-default">
            {reviewsToAnswer.map((r) => (
              ...
              >
                ...
                <span className="text-right text-xs tabular-nums text-primary/40">
                  {r.time}
                </span>
                <Button
                  type="button"
      ...
      <section className="grid items-stretch gap-5 xl:grid-cols-3">
          ...
          <div className="flex flex-1 flex-col divide-y divide-border-default">
            {contentsToApprove.map((c) => (
              ...
              >
                <div
                  className={cn(
                    'relative h-10 w-10 shrink-0 overflow-visible rounded-lg',
                    c.bg,
                  )}
                >
        ...
        <Panel title="Plan du jour" action={<PanelLink>Modifier</PanelLink>}>
          <div className="divide-y divide-border-default">
            {dailyPlan.map((item) => (
              <div
                key={item.time}
    ...
    <Card padding="none" className="flex flex-col">
      <div className="flex flex-col gap-3 p-5">
        <div className="flex items-center gap-2.5">
          ...
          <p className="text-sm font-medium leading-snug text-primary/70">
            {metric.label}
          </p>
        </div>
        <div>
      ...
      <div className="px-5 py-3">
        <Button
          variant="ghost"
          size="sm"
          className="h-auto p-0 text-status-success hover:bg-transparent hover:text-status-success/80"
        >
          {metric.linkText}
...
function ReviewAvatar({ source }: { source: string }) {
  ...
  return <Avatar fallback={source} size="sm" className={cls} />;
}
...
function PanelLink({ children }: { children: React.ReactNode }) {
  return (
    <Button
      variant="ghost"
      size="sm"
      className="h-auto p-0 text-primary/50 hover:bg-transparent hover:text-primary"
    >
      {children}
    </Button>
  );
